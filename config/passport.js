...
var minecraft = require('../mojang/mojangService');
    ...
    passport.use('local-signup', new LocalStrategy({
        ...
        process.nextTick(function () {
            ...
            User.findOne({'local.username': username}, function (err, user) {
                ...
                minecraft.playerExists("asouer", function (exists, json) {
                    if (exists) {
                        ...
                        newUser.info.first_name = req.body.first;
                        newUser.info.last_name = req.body.last;
                        newUser.info.email = req.body.email;
                        newUser.info.mc_name = req.body.mc_name;
                        newUser.info.mc_uuid = uuid;
                        ...
                        return done(null, false, req.flash('message', 'Sorry, no minecraft user exists'));
                    }
                });
            });
        });
